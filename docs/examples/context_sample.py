...
print(
    f"context.getPrimitiveNormal(patch_uuid): {context.getPrimitiveNormal(patch_uuid)}"
)

print(
    f"context.getPrimitiveVertices(patch_uuid): {context.getPrimitiveVertices(patch_uuid)}"
)
